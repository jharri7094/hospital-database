...
public class NurseDeleteFrame extends JFrame{
	
String[] options1 = {"Nurse ID", "Specialization"};
          ...
          String query = "";
	        try {
	            ...
	            if(specInput.equals("")) {
	            	...
	            	query = "DELETE FROM Projectdb.Nurse WHERE NSpecilization='" + specInput + "'";
	            	stmt.executeUpdate(query);
	            	
            		
            		String resultText = "<html>You have deleted Nurse(s) with: <br> Specialization = " + specInput + "</br></html>";
          ...
          String query = "";
	        try {
	            ...
	            if(idInput.equals("")) {
	            	...
	            	query = "DELETE FROM Projectdb.Nurse WHERE NurseID='" + idInput+ "'";
	            	stmt.executeUpdate(query);
	            	
            		
            		String resultText = "<html>You have deleted Nurse(s) with: <br> Nurse ID = " + idInput + "</br></html>";
