...
public class NurseUpdateFrame extends JFrame{
	String[] options = {"Nurse ID", "Specialization"};
	JComboBox<String> updateDrop = new JComboBox<>(options);
	JLabel title = new JLabel("Update: Nurse");
	JLabel setLabel = new JLabel("Set Nurse(s) with:");
	...
	JTextField toUpdate = new JTextField();
	  ...
	  private void update(ActionEvent evt) {
          ...
          String setQueryPart = "";
          if(setDropInput.equals("Nurse ID")) {
        	  setQueryPart = "NurseID";
          }else if(setDropInput.equals("Specialization")){
        	  setQueryPart = "NSpecilization";
          }
          
          String toQueryPart = "";
          if(toDropInput.equals("Nurse ID")) {
        	  toQueryPart = "NurseID";
          }else if(toDropInput.equals("Specialization")) {
        	  toQueryPart = "NSpecilization";
          }
          ...
          String query = "";
	        try {
	            ...
	            if(setInput.equals("")) {
	            	...
	            	query = "UPDATE Projectdb.Nurse SET " + toQueryPart + "= '" + toInput + "' WHERE " + setQueryPart + "= '" 
	            + setInput + "'";
	            	stmt.executeUpdate(query);
	            	
            		String resultText = "<html>You have updated Nurse(s) with: <br>" + setDropInput + " = "  + setInput 
