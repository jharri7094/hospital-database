...
public class DoctorInsertFrame extends JFrame{
	JLabel title = new JLabel("Insert New Doctor");
	...
	JButton exitButton = new JButton("Exit");
	  ...
	  public void addDoctor(ActionEvent evt) {
	        ...
	        try {
	            ...
	            if(idInput.equals("")) {
		            JOptionPane.showMessageDialog(null, "You must insert a Doctor ID", "ERROR", JOptionPane.ERROR_MESSAGE);
	            }else {
	            	query = "INSERT INTO Projectdb.Doctor (DoctorID, DSpecilization) VALUES ('" + idInput + "', '" + specInput + "')";
		            rs = stmt.execute(query);
			        String resultText = "<html><br>You have successfully inserted a Doctor</br><br></br><br>" 
			        		+ "Doctor ID: " + idInput + "<blockquote>Specialization: " + specInput + "</blockquote></br>";
